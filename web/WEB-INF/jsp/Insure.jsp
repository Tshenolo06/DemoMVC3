...
<div class="component-content">
    ...
    <h1 style="text-align: center;"><span class="white-text" style="color:white; font:50px arial">What would you like to protect?</span></h1>
    </div>
</div>
</div>
...
<div class="container">
    <ul class="list-unstyled">
           ...
           <li class="col-md-2">
            <img src="../Icon-Laptop.svg" alt="" width="50"/>
           </li>
          <li class="col-md-2">
            <img src="../Icon-Funeral.svg" alt="" width="50"/>
          </li>
         <li class="col-md-2">
            <img src="../Icon-Plane.svg" alt="" width="50"/>
         </li>
         <li class="col-md-2">
            <img src="../Icon-Estate.svg" alt="" width="50"/>
         </li>
         <li class="col-md-2">
...
<a href="#" title="Bank" class="navigation-item-title external" style="color:white;">My car &</br>
    home
...
<a href="#" title="Borrow" class="navigation-item-title external" style="color:white;">My portable<br>possessions
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Savings-100x100-White.svg" alt="Save or Invest">-->
<a href="#" title="Save or Invest" class="navigation-item-title external" style="color:white;">My life &<br>funeral
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">My travel  
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>

<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Savings-100x100-White.svg" alt="Save or Invest">-->
<a href="#" title="Save or Invest" class="navigation-item-title external" style="color:white;">My will, trust &</br>estate
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
