...
<div class="component-content">
    ...
    <h1 style="text-align: center;"><span class="white-text" style="color:white; font:50px arial">Good morning.<br>
                What would you like to do?</span></h1>
    </div>
</div>
</div>
...
<div class="container">
    <ul class="list-unstyled">
        <li class="col-md-2">
            <img src="../Icon-Coins.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Flag.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Bank-house.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Competition.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Protect.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Global.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon_SelfService.svg" alt="" width="50"/>
        </li>
    </ul>
</div>
...
<a href="#" title="Bank" class="navigation-item-title external" style="color:white;">Open an</br>account online 
...
<a href="#" title="Borrow" class="navigation-item-title external" style="color:white;">Start my</br>business 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Savings-100x100-White.svg" alt="Save or Invest">-->
<a href="#" title="Save or Invest" class="navigation-item-title external" style="color:white;">Bank my<br>business 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Fund my<br>business 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>

<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Protect my<br>business 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>

<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Bank<br>internationally 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
...
<a href="#" title="Talk to us" class="navigation-item-title external" style="color:white;">FICA Self-<br>service</a>
</li>
</ul>
</div>
</div>
