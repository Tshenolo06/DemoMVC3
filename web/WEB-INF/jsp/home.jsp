                ...
                <ul class="col-md-3">
                        <h1 style="color:black;">Banking Solutions:</h1>
                            <p style="color:black;"><b>Accounts</b></p>
                                <li> <a href="Platinum.htm">Platinum Account</a></li>
                  ...
                  <div class="dropdown-menu" id="logonDropdown">
                   ...
                   <select>
                        ...
                        <option value="corporate" > eContract</option>
                          ...
                          <button type="button" class="btn btn-primary btn-md"><a href="Login.htm" style="color:white;">Logon</a></button>
                          <a href="redirectCreate.htm">Register</a>
                      </div>
...
<div class="container">
    <ul class="list-unstyled">
        <li class="col-md-2">
            <img src="../Icon-Safe.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Wallet.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Savings.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Move.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
...
<ul class="list-unstyled" id="2630">
    
<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Safe-100x100.svg" alt="Bank">-->
<a href="Bank.htm" title="Bank" class="navigation-item-title external" style="color:white;">Bank 
...
<a href="Borrow.htm" title="Borrow" class="navigation-item-title external" style="color:white;">Borrow 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Savings-100x100-White.svg" alt="Save or Invest">-->
<a href="Save.htm" title="Save or Invest" class="navigation-item-title external" style="color:white;">Save or Invest 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="Insure.htm" title="Insure" class="navigation-item-title external" style="color:white;">Insure 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
</ul>
...
<a href="Talk.htm" title="Talk to us" class="navigation-item-title external" style="color:white;">Talk to us</a>
</li>
</ul>
</div>
</div>
