...
<div class="component-content">
    ...
    <h1 style="text-align: center;"><span class="white-text" style="color:white; font:50px arial">Good day.<br>
            Welcome to Corporate &<br> Investment Banking</span></h1>
    </div>
</div>
</div>
...
<div class="container">
    <ul class="list-unstyled">
        <li class="col-md-2">
            <img src="../Icon-Information-Large.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Comparison.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Competition.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Africa.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
...
<a href="#" title="Bank" class="navigation-item-title external" style="color:white;">About us 
...
<a href="#" title="Borrow" class="navigation-item-title external" style="color:white;">Our offering 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Savings-100x100-White.svg" alt="Save or Invest">-->
<a href="#" title="Save or Invest" class="navigation-item-title external" style="color:white;">Sector<br>expertise 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Africa & global 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>

<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Banking<br>service 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
