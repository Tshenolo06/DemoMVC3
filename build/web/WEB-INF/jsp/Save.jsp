...
<div class="component-content">
    ...
    <h1 style="text-align: center;"><span class="white-text" style="color:white; font:50px arial">What would you like to save or invest for?</span></h1>
    </div>
</div>
</div>
...
<div class="container">
    <ul class="list-unstyled">
        <li class="col-md-1">
            <img src="../Icon-Raining.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Flag.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Family.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Milestone.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Everday.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Free.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
...
<a href="#" title="Bank" class="navigation-item-title external" style="color:white;">A rainy day
...
<a href="#" title="Borrow" class="navigation-item-title external" style="color:white;">A goal
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Savings-100x100-White.svg" alt="Save or Invest">-->
<a href="#" title="Save or Invest" class="navigation-item-title external" style="color:white;">My family or club
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Retirement 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>

<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">My future 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>

<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Tax-free<br>saving and<br>investments
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
