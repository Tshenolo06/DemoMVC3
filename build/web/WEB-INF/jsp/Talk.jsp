...
<div class="component-content">
    <div class="richText-content"></br></br></br></br></br></br></br></br></br></br>
        <h1 style="text-align: center;"><span class="white-text" style="color:white; font:50px arial">Get the answers you need.<br> Prosper.</span></h1>
    </div>
</div>
</div></br></br></br></br></br></br></br></br></br></br>
<div class="container" id="Paballo">
    <div class="row">
        <div class="col-md-4"><h3>Connect with us<br><h6>Send us email or contact us directly</h6></h3></div>
        <div class="col-md-4"><h3>Locate us<br><h6>Find any of our branches or ATM's</h6></h3></div>
        <div class="col-md-4"><h3>Send us your<br><h6>We're always listening to how we can<br>improve</h6></h3></div>
    </div>
</div>
