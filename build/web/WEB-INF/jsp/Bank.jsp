...
<div class="component-content">
    ...
    <h1 style="text-align: center;"><span class="white-text" style="color:white; font:50px arial">What banking solution would you like?</span></h1>
    </div>
</div>
</div>
...
<div class="container">
    <ul class="list-unstyled">
        <li class="col-md-1">
            <img src="../Icon-Bank-Account.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Card.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Student.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Islam.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Global.svg" alt="" width="50"/>
</li>
 <li class="col-md-1">
            <img src="../Icon-Rewards.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
...
<a href="#" title="Bank" class="navigation-item-title external" style="color:white;">An account
...
<a href="#" title="Borrow" class="navigation-item-title external" style="color:white;">A credit card
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Savings-100x100-White.svg" alt="Save or Invest">-->
<a href="#" title="Save or Invest" class="navigation-item-title external" style="color:white;">Youth &<br>student<br> banking 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Islamic<br>banking 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>

<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">International<br>banking 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>

<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Absa Rewards 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
