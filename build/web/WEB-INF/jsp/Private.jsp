...
<div class="container">
    <ul class="list-unstyled">
        <li class="col-md-2">
            <img src="../Icon-WhyPrivate.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Bank-house.svg" alt="" width="50"/>
        </li>
        <li class="col-md-2">
            <img src="../Icon-Save-TimeMoney.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Cash-Back.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Protect.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Briefcase.svg" alt="" width="50"/>
        </li>
        <li class="col-md-1">
            <img src="../Icon-Mobile.svg" alt="" width="50"/>
        </li>
    </ul>
</div>
...
<a href="#" title="Bank" class="navigation-item-title external" style="color:white;">Why Private</br>
    Banking
...
<a href="#" title="Borrow" class="navigation-item-title external" style="color:white;">Banking 
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-2">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Savings-100x100-White.svg" alt="Save or Invest">-->
<a href="#" title="Save or Invest" class="navigation-item-title external" style="color:white;">Finance
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Wealth</br>Creation  
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>

<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Savings-100x100-White.svg" alt="Save or Invest">-->
<a href="#" title="Save or Invest" class="navigation-item-title external" style="color:white;">Wealth</br>Protection
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
					
<li class="col-md-1">
<!--<img src="/content/dam/south-africa/absa/Iconography/White/Icon-Move-to-Absa-100x100.svg" alt="Insure">-->
<a href="#" title="Insure" class="navigation-item-title external" style="color:white;">Young</br>Professionals  
<span tabindex="0" class="navigation-item-decoration"></span></a>
</li>
</ul>
...
<a href="#" title="Talk to us" class="navigation-item-title external" style="color:white;">Get in touch</a>
</li>
</ul>
</div>
</div>
